...
namespace ShaderEffectLibrary
{
    ...
    public class MonochromeEffect : ShaderEffect
    {
        ...
        /// </summary>
        public static readonly DependencyProperty FilterColorProperty = DependencyProperty.Register("FilterColor", typeof(Color), typeof(MonochromeEffect), new UIPropertyMetadata(Colors.Transparent, PixelShaderConstantCallback(0)));
