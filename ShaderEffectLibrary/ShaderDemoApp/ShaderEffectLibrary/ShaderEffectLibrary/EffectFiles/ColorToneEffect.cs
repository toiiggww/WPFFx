...
namespace ShaderEffectLibrary
{
    ...
    public class ColorToneEffect : ShaderEffect
    {
        ...
        public static readonly DependencyProperty LightColorProperty =
            DependencyProperty.Register("LightColor", typeof(Color), typeof(ColorToneEffect), new UIPropertyMetadata(Color.FromScRgb(1.0f, 1.0f, 0.9f, 0.5f), PixelShaderConstantCallback(2)));
        ...
        public static readonly DependencyProperty DarkColorProperty =
            DependencyProperty.Register("DarkColor", typeof(Color), typeof(ColorToneEffect), new UIPropertyMetadata(Color.FromScRgb(1.0f, 0.2f, 0.05f, 0.0f), PixelShaderConstantCallback(3)));
