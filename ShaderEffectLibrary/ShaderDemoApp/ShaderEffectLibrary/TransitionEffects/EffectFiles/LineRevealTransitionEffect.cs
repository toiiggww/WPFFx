...
namespace TransitionEffects
{
    ...
    public class LineRevealTransitionEffect : TransitionEffect
    {
        ...
        /// </summary>
        public static readonly DependencyProperty LineOriginProperty = DependencyProperty.Register("LineOrigin", typeof(Vector), typeof(LineRevealTransitionEffect), new UIPropertyMetadata(new Vector(-0.2, -0.2), PixelShaderConstantCallback(1)));
        ...
        /// </summary>
        public Vector LineOrigin
        {
            get { return (Vector)GetValue(LineOriginProperty); }
