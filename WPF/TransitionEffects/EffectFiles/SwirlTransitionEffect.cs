...
namespace TransitionEffects
{
    ...
    public class SwirlTransitionEffect : TransitionEffect
    {
        ...
        /// </summary>
        public static readonly DependencyProperty TwistAmountProperty = DependencyProperty.Register("FuzzyAmount", typeof(double), typeof(SwirlTransitionEffect), new UIPropertyMetadata(Math.PI, PixelShaderConstantCallback(1)));
        ...
        public SwirlTransitionEffect()
        {
            ...
            shader.UriSource = Global.MakePackUri("ShaderSource/SwirlTransitionEffect.ps");
            PixelShader = shader;
        }
