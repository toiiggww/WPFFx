...
namespace TransitionEffects
{
    ...
    public class SmoothSwirlGridTransitionEffect : TransitionEffect
    {
        ...
        /// </summary>
        public static readonly DependencyProperty TwistAmountProperty = DependencyProperty.Register("FuzzyAmount", typeof(double), typeof(SmoothSwirlGridTransitionEffect), new UIPropertyMetadata(Math.PI, PixelShaderConstantCallback(1)));
        ...
        public SmoothSwirlGridTransitionEffect()
        {
            ...
            shader.UriSource = Global.MakePackUri("ShaderSource/SmoothSwirlGridTransitionEffect.ps");
            PixelShader = shader;
        }
